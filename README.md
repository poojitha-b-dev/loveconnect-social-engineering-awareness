...
![Location Permission](screenshots/03_location_permission.png)

### 📷 Camera Permission Request

![Camera Permission](screenshots/04_camera_permission.png)

### 📂 Backend Before Demonstration

![Backend Before](screenshots/05_backend_before.png)

### 📂 Backend After Demonstration

![Backend After](screenshots/06_backend_after.png)
...
![Location Log](screenshots/07_location_txt.png)

### 📷 Captured Snapshot Example

![Snapshots](screenshots/08_snapshots.png)

### 🎤 Audio Recording Example

![Audio](screenshots/09_audio.png)

### 🎬 Awareness Video

![Awareness Video](screenshots/10_video.png)
